// https://api.cricapi.com/v1/series_info?apikey=80f3cfac-93eb-4e2c-ae08-9022a11fdde8&id=d5a498c8-7596-4b93-8ab0-e0efc3345312
export const matchList = [
  ...
  },
  {
    ...
    teams: ["Punjab Kings", "Mumbai Indians"],
    fantasyEnabled: false,
    bbbEnabled: false,
    hasSquad: true,
    matchStarted: false,
  ...
  },
  {
    ...
    teams: ["Lucknow Super Giants", "Chennai Super Kings"],
    fantasyEnabled: true,
    bbbEnabled: true,
    hasSquad: true,
    matchStarted: true,
  ...
  },
  {
    ...
    teams: ["Sunrisers Hyderabad", "Kolkata Knight Riders"],
    fantasyEnabled: false,
    bbbEnabled: false,
    hasSquad: true,
    matchStarted: false,
...
// https://api.cricapi.com/v1/match_info?apikey=80f3cfac-93eb-4e2c-ae08-9022a11fdde8&id=208d68e5-3fab-4f3b-88e9-29ec4a02d3e2
